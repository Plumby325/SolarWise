...
def make_description(feature, impact):
    label = FEATURE_LABELS.get(feature, feature)

    if impact > 0:
        direction = "예측 발전량을 증가시키는 방향으로 작용했습니다."
    else:
        direction = "예측 발전량을 감소시키는 방향으로 작용했습니다."

    return f"{label} feature가 {direction}"
    ...
    try:
        ...
        for i in top_idx:
            ...
            main_causes.append({
                ...
                "label": FEATURE_LABELS.get(feature, feature),
                "impact": impact,
                "description": make_description(feature, impact)
            })
